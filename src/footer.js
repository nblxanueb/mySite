    ...
    <div>
      <div className="footer">
        ...
        <div className="social-media">
          <div>
            <a
              href="https://drive.google.com/file/d/1Vl4B94y-i59bvsneqOudh9itTQHr9efN/view?usp=sharing"
              target="_blank"
          ...
          <div>
            <a
              href="https://www.linkedin.com/in/andrey-pykhantsev/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <div>
            <a
              href="https://github.com/nblxanueb"
              target="_blank"
              rel="noopener noreferrer"
            >
